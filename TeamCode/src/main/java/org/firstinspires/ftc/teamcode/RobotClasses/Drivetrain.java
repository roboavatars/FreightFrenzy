...
public class Drivetrain {
    ...
    public static double xKp = 0.15;
    public static double yKp = 0.06;
    public static double thetaKp = 0.8;
    public static double xKd = 0.006;
    public static double yKd = 0.002;
