...
public class Constants {
    ...
    public static double DEPOSIT_ARM_LOW_GOAL = 0;
    public static double DEPOSIT_ARM_MID_GOAL = 0.2;
    public static double DEPOSIT_ARM_TOP_GOAL = 0.3;
    public static double DEPOSIT_ARM_CAP = 0.4;
    public static double DEPOSIT_ARM_OVER_MOTOR = .8;
    public static double ARM_SERVO_2_OFFSET = 0.05;
